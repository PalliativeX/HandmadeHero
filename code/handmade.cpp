...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    for (int ControllerIndex = 0; ControllerIndex < ArrayCount(Input->Controllers); ControllerIndex++)
    {
        ...
        else
        {
            ...
            real32 PlayerSpeed = 4.f;
            if (Controller->ActionUp.EndedDown)
            {
                PlayerSpeed = 10.f;
            }
            dPlayerX *= PlayerSpeed; // NOTE: Both in meters
    ...
    DrawRectangle(Buffer, 0.0f, 0.0f, (real32)Buffer->Width, (real32)Buffer->Height, 1.f, 0.6f, 0.f);
    ...
    for (int32 RelRow = -10; RelRow < 10; RelRow++)
    {
        for (int32 RelColumn = -20; RelColumn < 20; RelColumn++)
        {
            ...
            // NOTE: Drawing a black tile which a player is in (for debugging)
